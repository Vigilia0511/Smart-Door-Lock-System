...
<body>
  <div class="container">
    ...
    <div class="image-container">
            <a href="index.php"> <img class="pic" src="bbq.png" alt="Image"></a>
        </div>
    ...
    <div class="response">
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($id) || empty($current_password)) {
          ...
          $url = "https://frequently-normal-moray.ngrok-free.app/change_password";
          $data = [
            "id" => $id,
...
function showModal(type, message) {
    ...
    window.onpopstate = function(event) {
        window.location.href = 'interface.php'; // Redirect to index.php
    };
